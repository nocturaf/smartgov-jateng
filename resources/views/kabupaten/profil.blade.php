        ...
        <div class="col-6 pr-4 pl-5">
            ...
            <div class="mt-5 bg-overlay-custom" style="background-image: url('images/profil-page/bg-7.png');">
                ...
                <div class="row mx-0 font-weight-normal">
                    ...
                    foreach ($agama as $aga) : ?>
                        <?php $totalPenduduk += $aga['nilai']; ?>
                    <?php endforeach; ?>

                    <div class="col-6">
                        <?php $total = 0;
                        foreach ($agama as $aga) : ?>
                            <div class="font-14 pt-3"><?= $aga['nama'] ?>
                                <span class="float-right pt-1" style="width:80px">
                                    <div class="progress">
                                        <?php $persentase = ($aga['nilai'] / $totalPenduduk) * 100; ?>
                                        <div class="progress-bar" role="progressbar" style="width: <?= $persentase; ?>%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                        <span class="float-right text-right position-absolute" style="right:48px"><?= substr($persentase, 0, 4); ?>%</span>
                                    </div>
                                </span>
                            </div>
                            <?php $total++;
            ...
            <div class="mt-5 bg-overlay-custom" style="background-image: url('images/profil-page/bg-8.png');">
                ...
                <div class="font-weight-normal">
                    ...
                    <?php $totalPenduduk = 0;
                    foreach ($suku as $suk) : ?>
                        <?php $totalPenduduk += $suk['nilai']; ?>
                    <?php endforeach; ?>

                    <?php foreach ($suku as $suk) : ?>

                        <div class="font-14 pt-3"><?= $suk['nama']; ?>
                            <span class="float-right pt-1" style="width:280px">
                                <div class="progress">
                                    <?php $persentase = ($suk['nilai'] / $totalPenduduk) * 100; ?>
                                    <div class="progress-bar" role="progressbar" style="width: <?= $persentase; ?>%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                    <span class="float-right text-right position-absolute" style="right:48px"><?= substr($persentase, 0, 4); ?>%</span>
                                </div>
                            </span>
